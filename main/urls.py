...
urlpatterns = [
    ...
    path('cancel_order/<int:order_id>/<path:url>/', views.cancel_order, name='cancel_order'),
    path('done_order/<int:order_id>/<path:url>/', views.done_order, name='done_order'),
    path('ready_order/<int:order_id>/<path:url>/', views.ready_order, name='ready_order'),
    path('add_menu/', views.add_menu, name='add_menu'),
    path('remove_menu/<int:menu_id>/', views.remove_menu, name='remove_menu'),
    path('sell_menu/<int:menu_id>/', views.sell_menu, name='sell_menu'),
    path('not_sell_menu/<int:menu_id>/', views.not_sell_menu, name='not_sell_menu'),
